...
--
-- Hôte : localhost:3306
-- Généré le : mer. 17 mai 2023 à 09:58
...
(247, 'J\'adore la 3D de Félix Duthion !', '2023-04-21 16:54:07', 'Art', './stockfile/', 35),
...
(264, 'Mon artiste préféré ? Le roi de la POP sans hésiter !', '2023-05-17 11:55:17', 'Musique', './stockfile/pochette forever Michael.png', 35);
...
--
ALTER TABLE `tweet`
  MODIFY `id_tweet` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=265;

--
-- AUTO_INCREMENT pour la table `users`
--
ALTER TABLE `users`
  MODIFY `id_users` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
COMMIT;
